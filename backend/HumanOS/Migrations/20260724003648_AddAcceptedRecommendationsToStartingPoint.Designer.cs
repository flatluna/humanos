...
namespace HumanOS.Migrations
{
    ...
    [Migration("20260724003648_AddAcceptedRecommendationsToStartingPoint")]
    partial class AddAcceptedRecommendationsToStartingPoint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HumanOS.Models.Capabilities.Capability", b =>
                {
                    ...
                    b.HasIndex("SubjectId")
                        .HasDatabaseName("IX_Capability_SubjectId");
            ...
            modelBuilder.Entity("HumanOS.Models.Capabilities.Graph.CapabilityGenerationUsage", b =>
                {
                    b.Property<Guid>("CapabilityGenerationUsageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("CapabilityGenerationUsageId");

                    b.HasIndex("CapabilityGraphId");

                    b.HasIndex("CapabilityId");

                    b.ToTable("CapabilityGenerationUsages");
                });
            ...
            modelBuilder.Entity("HumanOS.Models.Capabilities.Subject", b =>
                {
                    b.Property<Guid>("SubjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("HumanOS.Models.Capabilities.SubjectTranslation", b =>
                {
                    b.Property<Guid>("SubjectId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SubjectTranslation", "dbo");
                });
            ...
            modelBuilder.Entity("HumanOS.Models.Motivations.Motivation", b =>
                {
                    ...
                    b.ToTable("Motivation", "dbo");
                });

            modelBuilder.Entity("HumanOS.Models.Motivations.MotivationTranslation", b =>
                {
                    b.Property<Guid>("MotivationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("MotivationId", "LanguageCode")
                        .HasName("PK_MotivationTranslation");

                    b.HasIndex("LanguageCode");

                    b.ToTable("MotivationTranslation", "dbo");
                });

            modelBuilder.Entity("HumanOS.Models.Motivations.PersonMotivation", b =>
                {
                    b.Property<Guid>("PersonMotivationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");
            ...
            modelBuilder.Entity("HumanOS.Models.People.PersonCurrentSituation", b =>
                {
                    b.Property<Guid>("PersonCurrentSituationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");
                    ...
                    b.Property<string>("SelectedSubjectCodes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SelfAssessedLevelsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("PersonCurrentSituationId")
                    ...
                    b.ToTable("PersonCurrentSituation", "dbo");
                });

            modelBuilder.Entity("HumanOS.Models.People.PersonFutureDirection", b =>
                {
                    b.Property<Guid>("PersonFutureDirectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");
                    ...
                    b.Property<string>("SelectedGoalIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SelectedMotivationCodes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("PersonFutureDirectionId")
                    ...
                    b.ToTable("PersonFutureDirection", "dbo");
                });
            ...
            modelBuilder.Entity("HumanOS.Models.People.PersonStartingPoint", b =>
                {
                    b.Property<Guid>("PersonStartingPointId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");

                    b.Property<string>("AcceptedRecommendationsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("[]");
                    ...
                    b.Property<string>("GapCapabilitiesBySubjectJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SelectedCapabilityIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("PersonStartingPointId")
                    ...
                    b.ToTable("PersonStartingPoint", "dbo");
                });
            ...
            modelBuilder.Entity("HumanOS.Models.Programs.LearningProgram", b =>
                {
            ...
            modelBuilder.Entity("HumanOS.Models.Programs.ProgramCapability", b =>
                {
                    b.Property<Guid>("ProgramCapabilityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");
                    ...
                    b.HasKey("ProgramCapabilityId")
                        .HasName("PK_ProgramCapability");

                    b.HasIndex("CapabilityId");

                    b.HasIndex("ProgramId", "CapabilityId")
                        .IsUnique()
                    ...
                    b.ToTable("ProgramCapability", "dbo");
                });

            modelBuilder.Entity("HumanOS.Models.Programs.ProgramTranslation", b =>
                {
                    b.Property<Guid>("ProgramId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ProgramId", "LanguageCode")
                        .HasName("PK_ProgramTranslation");

                    b.HasIndex("LanguageCode");

                    b.ToTable("ProgramTranslation", "dbo");
                });
            ...
            modelBuilder.Entity("HumanOS.Models.Capabilities.Capability", b =>
                {
                    ...
                    b.HasOne("HumanOS.Models.Capabilities.Subject", "Subject")
                        .WithMany("Capabilities")
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Capability_Subject");
            ...
            modelBuilder.Entity("HumanOS.Models.Capabilities.SubjectTranslation", b =>
                {
                    b.HasOne("HumanOS.Models.Localization.Language", "Language")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SubjectTranslation_Language");
            ...
            modelBuilder.Entity("HumanOS.Models.Motivations.MotivationTranslation", b =>
                {
                    b.HasOne("HumanOS.Models.Localization.Language", "Language")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_MotivationTranslation_Language");

                    b.HasOne("HumanOS.Models.Motivations.Motivation", "Motivation")
                        .WithMany("Translations")
                        .HasForeignKey("MotivationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_MotivationTranslation_Motivation");
            ...
            modelBuilder.Entity("HumanOS.Models.People.PersonCurrentSituation", b =>
                {
                    b.HasOne("HumanOS.Models.People.Person", "Person")
                        .WithOne()
                        .HasForeignKey("HumanOS.Models.People.PersonCurrentSituation", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("HumanOS.Models.People.PersonFutureDirection", b =>
                {
                    b.HasOne("HumanOS.Models.People.Person", "Person")
                        .WithOne()
                        .HasForeignKey("HumanOS.Models.People.PersonFutureDirection", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("HumanOS.Models.People.PersonStartingPoint", b =>
                {
                    b.HasOne("HumanOS.Models.People.Person", "Person")
                        .WithOne()
                        .HasForeignKey("HumanOS.Models.People.PersonStartingPoint", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("HumanOS.Models.Programs.ProgramCapability", b =>
                {
                    ...
                    b.HasOne("HumanOS.Models.Programs.LearningProgram", "Program")
                        .WithMany("ProgramCapabilities")
            ...
            modelBuilder.Entity("HumanOS.Models.Motivations.Motivation", b =>
                {
                    b.Navigation("PersonMotivations");
            ...
            modelBuilder.Entity("HumanOS.Models.Programs.LearningProgram", b =>
                {
                    b.Navigation("ProgramCapabilities");
