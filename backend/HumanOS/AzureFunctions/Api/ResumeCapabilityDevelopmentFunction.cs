...
public sealed class ResumeCapabilityDevelopmentFunction
{
    private readonly PersonCapabilityService _personCapabilityService;

    public ResumeCapabilityDevelopmentFunction(PersonCapabilityService personCapabilityService)
    {
        _personCapabilityService = personCapabilityService;
    }

    [Function("ResumeCapabilityDevelopment")]
    public async Task<HttpResponseData> RunAsync(
        [HttpTrigger(
            AuthorizationLevel.Anonymous,
            "post",
            Route = "people/{personId:guid}/capabilities/{personCapabilityId:guid}/resume")]
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var result = await _personCapabilityService.ResumeAsync(personCapabilityId, cancellationToken);
